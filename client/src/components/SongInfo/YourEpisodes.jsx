...
function YourEpisodes () {
    ...
    useEffect(() => {
        ...
        axios.get("https://apg-saavn-api.herokuapp.com/playlist/?q=https://www.jiosaavn.com/featured/dance-hits-2021---hindi/eaTB-JpePNYGSw2I1RxdhQ__").then((res) => {
    ...
    return (
        <div  style = {{
            ...
            {yourEpisodes.map((e) => (
              <div
                    key = {e.id}
                    className = {styles["prodcastContDiv"]}
                >
                    {/* <img src="/Images/pause.svg" alt="image_pause" className={styles["pauseImg"]} /> */}
                    <img src= {e.image} alt="song_image"  className={styles["prodImg"]} />
