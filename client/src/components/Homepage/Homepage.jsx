    ...
    return <>
        ...
        <div className={styles["navbar-parent"]}>
            ...
            <div className={styles["options-div"]}>
                ...
                <div>
                    <div>Home</div>
                    <div style={{width:"43px",height:"3px",background:"#2A2D36",border:"1px solid #2A2D36",marginTop:"8%"}}></div>
                </div>
                <div>Browse</div>
                <div>Upgrade</div>
            </div>
            ...
            <div className={styles["languages-div"]}>
                ...
                <Arrow onClick={showLanguages} flag={showingLanguages} className={styles["down-arrow"]} src={downarrow} alt="dropdown arrow" />
                {/* Music Languages */}
            </div>
